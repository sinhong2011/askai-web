...
本文档用于解释 問問AI - Ask AI 的部分功能介绍和设计原则。
...
- 注入系统级提示信息、用户输入预处理：详情请看 [https://github.com/sinhong2011/askai-web/issues/2144](https://github.com/sinhong2011/askai-web/issues/2144)
